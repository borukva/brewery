...
public class BrewBlocks {
    ...
    public static final Block BARREL_SPIGOT = register("barrel_spigot", AbstractBlock.Settings.copy(Blocks.TRIPWIRE_HOOK).breakInstantly().noCollision().solidBlock(Blocks::never), BrewSpigotBlock::new);
